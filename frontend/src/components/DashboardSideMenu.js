        ...
        if (commonMethods.isUserTypeStylist(userType)) {
            return(
                <Menu pointing vertical>
                    ...
                    <Menu.Item name='booking requests' active={activeItem === 'booking requests'} as={NavLink} to={CLIENT_ROUTES.DASHBOARD_BOOKING_REQUESTS} onClick={this.handleItemClick} />
